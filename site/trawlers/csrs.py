...
def get_data(the_date):
    ...
    with open('./data/sid_Roth.json', 'r') as file:
        data = json.load(file)
    ...
    for program in Day:
        ...
        central_time_str = datetime.datetime.strptime(time_str, "%I:%M%p")
        
        starts = datetime.datetime.strptime("{} {} -0400".format(the_date.strftime("%m/%d/%Y"), time_str), "%m/%d/%Y %I:%M%p %z")
