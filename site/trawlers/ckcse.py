...
def get_data(the_date):
    try:
        url = "https://lifechristian.tv/schedule#{}".format(the_date.strftime("%A").lower())
        ...
        for program_element in program_elements_filtered:
            ...
            starts = datetime.datetime.strptime("{} {} -0600".format(the_date.strftime("%m/%d/%Y"), start_time_am_pm), "%m/%d/%Y %I:%M%p %z").astimezone(timezone('US/Pacific'))
...
class TrawlerKCSETVLife(Trawler):
    @staticmethod
