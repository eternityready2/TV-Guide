...
def get_data(the_date):
    ...
    try:
        ...
        for program in data[a]:
            ...
            start_time = datetime.datetime.fromtimestamp(start_time_utc, pytz.utc).astimezone(pacific_timezone)
            end_time = datetime.datetime.fromtimestamp(end_time_utc, pytz.utc).astimezone(pacific_timezone)
