...
def get_data(the_date):
    ...
    with open('./data/IhopKC_DATA.json', 'r') as file:
        data = json.load(file)
    ...
    for program in Day:
        ...
        program_name = program["event"]
        
        starts = datetime.datetime.strptime("{} {} -0500".format(the_date.strftime("%m/%d/%Y"), time_str), "%m/%d/%Y %H:%M %z")
