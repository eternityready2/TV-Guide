...
def get_data(the_date):
    try:
        response = requests.get(
            "http://llbnarabic.hostedbroadcasting.com/external_schedule/select_calendar_view_day/1?day={}&month={}&year={}".format(the_date.day, the_date.month, the_date.year),
...
class Trawlerllbnarabic(Trawler):
    @staticmethod
